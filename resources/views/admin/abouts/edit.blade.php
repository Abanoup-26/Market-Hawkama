                ...
                <div class="row justify-content-between">
                    <div class="form-group col-4">
                        ...
                        <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text"
                            name="phone" id="phone" value="{{ old('phone', $about->phone) }}" required>
                        @if ($errors->has('phone'))
                    ...
                    <div class="form-group col-4">
                        ...
                        <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email"
                            name="email" id="email" value="{{ old('email', $about->email) }}" required>
                        @if ($errors->has('email'))
                            <div class="invalid-feedback">
                                {{ $errors->first('email') }}
                            </div>
                ...
                <div class="row justify-content-between">
                    <div class="form-group col-3">
                        ...
                        <input class="form-control {{ $errors->has('location') ? 'is-invalid' : '' }}" type="text"
                            name="location" id="location" value="{{ old('location', $about->location) }}" required>
                    ...
                    <div class="form-group col-3">
                        ...
                        <input class="form-control {{ $errors->has('whatsapp') ? 'is-invalid' : '' }}" type="text"
                            name="whatsapp" id="whatsapp" value="{{ old('whatsapp', $about->whatsapp) }}" required>
                    ...
                    <div class="form-group col-3">
                        ...
                        <input class="form-control {{ $errors->has('instagram') ? 'is-invalid' : '' }}" type="text"
                            name="instagram" id="instagram" value="{{ old('instagram', $about->instagram) }}" required>
                    ...
                    <div class="form-group col-3">
                        ...
                        <input class="form-control {{ $errors->has('twitter') ? 'is-invalid' : '' }}" type="text"
                            name="twitter" id="twitter" value="{{ old('twitter', $about->twitter) }}" required>
